...
if (function_exists('add_action')) {
	...
	die('<!DOCTYPE html><html><head><title>Body Mass Index | WordPress Plugin</title></head><body>Nothing here!<br /><small>This message is brought to you by <a href="http://wordpress.org/extend/plugins/body-mass-index-calculator-widget/">wet_bmicalc, a body mass index calculating widget disguised as a WordPress plugin</a>.</small></body></html>');
}
